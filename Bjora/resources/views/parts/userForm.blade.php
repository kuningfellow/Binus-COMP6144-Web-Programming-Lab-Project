<form method="POST" novalidate action="/users/{{ $action }}" enctype="multipart/form-data" id="user">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <textarea id="address" name="address" placeholder="{{ $user['address']??"Address" }}" class="form-control @error('address') is-invalid @enderror" rows=3>{{ $user['address']??"" }}</textarea>
            @error('address')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input id="profile_picture" type="file" name="profile_picture" class="form-control @error('profile_picture') is-invalid @enderror">
